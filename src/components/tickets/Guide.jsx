  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-red-600">
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-16 relative">
        ...
        <header className="mb-12 md:mb-20 select-none">
          <div className="flex items-center gap-3 mb-6 animate-in fade-in slide-in-from-left duration-700">
            <div className="h-px w-12 bg-red-600" />
            <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.5em] text-red-600">Proceso de Venta Oficial 2026</span>
          </div>
          <h1 className="text-5xl md:text-8xl font-black italic uppercase tracking-tighter leading-[0.85] mb-6 animate-in fade-in slide-in-from-bottom duration-1000">
            Consigue tu <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-zinc-600">Entrada VIP</span>
          </h1>
          <p className="max-w-xl text-zinc-500 text-sm md:text-base font-medium leading-relaxed border-l border-zinc-800 pl-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10">
          ...
          <nav className="lg:col-span-4 flex flex-col gap-3">
            {detailedSteps.map((step, index) => (
              <button
                ...
                className={`group relative overflow-hidden p-5 rounded-2xl border transition-all duration-500 text-left cursor-pointer ${
                  activeTab === index 
                  ? 'bg-zinc-900 border-red-600/50 shadow-[0_20px_40px_rgba(220,38,38,0.1)]' 
              ...
              >
                ...
                <div className="flex justify-between items-center mb-1">
                  <span className={`text-[9px] font-black uppercase tracking-widest ${activeTab === index ? 'text-red-500' : 'text-zinc-600'}`}>
                    {step.id}
                  </span>
                ...
                <h3 className={`text-base font-black uppercase italic transition-colors ${activeTab === index ? 'text-white' : 'text-zinc-500'}`}>
                  {step.title}
                </h3>
              </button>
            ))}
            ...
            {/* Banner Ayuda */}
            <div className="mt-6 p-6 rounded-[2rem] bg-gradient-to-br from-zinc-900 to-black border border-white/5 hidden lg:block select-none">
              <div className="flex items-center gap-3 mb-4 text-amber-500">
                <AlertTriangle size={18} />
                <span className="text-[10px] font-black uppercase tracking-widest">Atención al Cliente</span>
              </div>
              <p className="text-[11px] text-zinc-500 leading-relaxed font-bold uppercase mb-4">
          ...
          >
            <div className={`min-h-[500px] bg-zinc-900/30 border border-white/10 rounded-[2.5rem] md:rounded-[3.5rem] p-8 md:p-14 backdrop-blur-xl transition-all duration-700 ${isAnimate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-amber-500 text-[10px] md:text-xs font-black uppercase tracking-[0.3em] flex items-center gap-2">
              ...
              <div className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-6">
                    <h4 className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] text-zinc-500">
                    ...
                    <ul className="space-y-4">
                      {detailedSteps[activeTab].instructions.map((inst, i) => (
                        <li key={i} className="flex items-start gap-4">
                          ...
                          <span className="text-sm text-zinc-400 font-bold uppercase leading-snug">
                            {inst}
                          </span>
                        </li>
                      ))}
        ...
        <section className="mt-24 select-none">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-zinc-900 to-black border border-white/5 rounded-[3rem] p-8 md:p-12">
               <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
                  <div>
                    <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-2">Liquidación Oficial</h2>
                    <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Cuentas autorizadas por la federación</p>
                  </div>
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white/5 border border-white/5 p-8 rounded-[2.5rem] hover:bg-white/10 transition-all duration-300 group cursor-default">
                    ...
                    <p className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-1">Banco de Crédito</p>
        ...
        <section className="mt-24 select-none">
          <div className="text-center mb-12">
            <h2 className="text-xs font-black uppercase tracking-[0.4em] text-gray-300 mb-4 italic">Zona de Ayuda</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="p-8 bg-zinc-900/50 border border-white/5 rounded-3xl hover:border-white/10 transition-all">
                ...
                <p className="text-xs text-zinc-500 leading-relaxed font-bold uppercase tracking-wide">
                  {item.a}
                </p>
              </div>
            ))}
