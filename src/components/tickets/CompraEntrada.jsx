    ...
    <div className="relative flex flex-col h-full sm:p-12 p-2 rounded-[3rem] backdrop-blur-2xl transition-all duration-700 group overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-5">
        ...
        <div className="flex items-center justify-between rounded-2xl px-6 py-4 border border-white/5 bg-white/[0.02]">
          ...
          <span className="font-mono text-xl text-white font-light w-12 text-center tabular-nums">
            {quantity}
          </span>
          <button
            onClick={() => setQuantity(Math.max(0, quantity + 1))}
      ...
      {showCheckout ? (
        ...
        <div className="min-h-screen text-white font-sans selection:bg-amber-500/30 flex items-center justify-center flex-col">
          ...
          <div className="w-full space-y-0 relative">
            <div className="w-full flex flex-col items-center space-y-12 pt-20 bg-black">
            ...
            <div className="pt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 px-5 bg-[#000000]">
