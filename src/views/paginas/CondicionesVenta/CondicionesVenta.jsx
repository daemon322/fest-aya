          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-3xl w-full md:w-auto">
            ...
            <div className="text-xs text-slate-400 space-y-1 font-medium">
              <p className="flex justify-between">
                <span>RUC:</span>{" "}
                <span className="text-slate-200">20574793379</span>
              </p>
              <p className="flex justify-between gap-8">
                <span>Domicilio:</span>{" "}
                <span className="text-slate-200">Ayacucho, Perú</span>
              </p>
              <p className="flex justify-between">
                <span>Evento:</span>{" "}
      ...
      <div className="w-full mx-auto px-4 md:px-8 py-16">
                ...
                {sections.map((section) => (
                  ...
                  >
                    <div className="flex items-center">
                      <span
                        className={`text-[10px] font-mono mr-3 ${activeSection === section.id ? "text-indigo-600 font-bold" : "text-slate-300"}`}
                      >
                    ...
                    <ChevronRight
                      className={`w-4 h-4 transition-transform ${activeSection === section.id ? "translate-x-0" : "-translate-x-2 opacity-0 group-hover:opacity-100"}`}
                    />
                  </button>
                ))}
              </nav>
          ...
          <div className="lg:col-span-8 space-y-20 pb-24">
            ...
            <div className="bg-indigo-50 border-l-4 border-indigo-600 p-8 rounded-r-3xl">
              <div className="flex space-x-5">
                ...
                <p className="text-sm text-indigo-900 leading-relaxed font-medium">
                  Este documento se rige bajo el{" "}
                  <strong>
                    Código de Protección y Defensa del Consumidor (Ley N° 29571)
                  </strong>{" "}
                  y demás normas concordantes del Estado Peruano. Al realizar
                  una compra, usted declara haber leído y aceptado cada cláusula
                  aquí expuesta.
                </p>
              </div>
            </div>
            ...
            <section id="objeto" className="scroll-mt-12">
              <h2 className="text-3xl font-black mb-6 text-slate-900 flex items-baseline tracking-tight">
                <span className="text-indigo-600 mr-4 text-xl font-mono opacity-50">
                  01.
                </span>
                Objeto del Contrato
              </h2>
              <div className="prose prose-slate max-w-none text-slate-600 space-y-4 text-lg leading-relaxed">
                <p>
                  El presente contrato tiene por objeto regular los términos y
                  condiciones de la venta de entradas para el evento deportivo{" "}
                  <strong>“¡Vóley al Límite, sin filtros en la cancha!”</strong>
                  .
                </p>
                <p className="text-base">
                  MULTISERVICIOS KASURI E.I.R.L (en adelante "La Empresa") actúa
                  como organizador y único responsable legal del evento,
                  utilizando sistemas tecnológicos de terceros exclusivamente
                  como canal de venta y gestión de tickets.
                </p>
              </div>
            </section>
            ...
            <section id="proceso" className="scroll-mt-12">
              ...
              <div className="grid gap-6">
                <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100 hover:shadow-inner transition-all">
                  <h4 className="font-bold mb-3 text-slate-900 text-xl">
                    Identificación Obligatoria
                  </h4>
                  <p className="text-slate-500 leading-relaxed">
                    Es obligación estricta del cliente proporcionar datos de
                    identidad exactos. En cumplimiento con la{" "}
                    <strong>Ley N° 30037</strong> (Ley que previene la violencia
                    en espectáculos deportivos), cada entrada debe estar
                    vinculada obligatoriamente a un DNI o Carnet de Extranjería
                    vigente.
                  </p>
                </div>
                <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100 hover:shadow-inner transition-all">
                  ...
                  <p className="text-slate-500 leading-relaxed">
                    La compra se considera perfeccionada y el contrato celebrado
                    únicamente tras la recepción del correo de confirmación y el
                    cargo efectivo en la cuenta del usuario.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="cambios" className="scroll-mt-12">
              ...
              <div className="bg-slate-900 text-white p-10 rounded-[3rem] relative overflow-hidden shadow-2xl">
                ...
                <h4 className="text-amber-400 font-bold mb-6 uppercase tracking-widest text-xs">
                  Advertencia Legal Importante
                </h4>
                <p className="text-indigo-100 leading-relaxed mb-8 text-lg">
                  Conforme al <strong>Art. 52.2 de la Ley 29571</strong>, el
                  derecho a desistimiento unilateral no aplica en contratos de
                  prestación de servicios para espectáculos públicos con fecha
                  determinada.
                </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border-2 border-slate-100 p-8 rounded-[2.5rem] hover:border-indigo-100 transition-all group">
                  ...
                  <p className="text-xs text-slate-400 mb-6 font-medium">
                    Atención prioritaria para consultas sobre términos
                    contractuales.
                  </p>
                  <span className="text-sm font-black text-indigo-600 border-b-2 border-indigo-100 hover:border-indigo-600 transition-all">
                    antreus28d@gmail.com
                  </span>
                </div>
                <div className="bg-white border-2 border-slate-100 p-8 rounded-[2.5rem] hover:border-indigo-100 transition-all group">
                  ...
                  <p className="text-xs text-slate-400 mb-6 font-medium">
                    Conforme a las directrices de INDECOPI.
                  </p>
                  <a
                    href="/paginas/LibroReclamaciones"
                    className="flex items-center text-sm font-black text-indigo-600 border-b-2 border-indigo-100 hover:border-indigo-600 transition-all"
                  >
                    Registrar Reclamo
            ...
            <section
              id="legal"
              className="scroll-mt-12 border-t-2 border-slate-100 pt-20"
            >
              <h2 className="text-3xl font-black mb-8 text-slate-900 flex items-baseline tracking-tight">
                <span className="text-indigo-600 mr-4 text-xl font-mono opacity-50">
                  10.
              ...
              <p className="text-slate-500 leading-relaxed mb-10 italic">
                Cualquier controversia derivada de la interpretación de este
                contrato será sometida a la competencia exclusiva de los jueces
                y tribunales del <strong>Distrito Judicial de Ayacucho</strong>,
                renunciando el usuario a cualquier otro fuero por razón de
                domicilio.
              </p>
        ...
        <div className="mt-24 border-t-8 border-slate-900 pt-16 text-center pb-24">
          ...
          <p className="mt-8 text-slate-400 text-xs max-w-lg mx-auto leading-relaxed font-medium uppercase tracking-widest px-4">
            Este documento digital tiene plena validez probatoria conforme a la
