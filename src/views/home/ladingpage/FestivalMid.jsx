  ...
  const artists = [
    {
      ...
      image: 'https://larepublica.cronosmedia.glr.pe/migration/images/2NHXSOHWFJB2VCVLHC656JU4GA.jpg',
      year: '1975',
      award: 'Oro'
    },
    {
      ...
      image: 'https://static.vaope.com/public/artists/9670-AGUA-MARINA-ICONO.jpg',
      year: '1968',
      award: 'Platino'
    },
    {
      ...
      image: 'https://upload.wikimedia.org/wikipedia/commons/0/0d/Daniela_Darcourt_-_2021.jpg',
      year: '2015',
      award: 'Latino'
    }
  ];
...
export default function App() {
  ...
  return (
    <div className="bg-[#050505] text-[#f4f4f4] font-serif selection:bg-amber-500/30 overflow-x-hidden">
      ...
      <motion.section
        ...
        className="py-40 px-6 md:px-20 bg-black"
      >
...
{/* Grid de artistas */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 items-center">
          ...
          <motion.div variants={itemVariants} className="relative group">
            ...
            <img
              ...
              alt="Hospitality"
            />
            <div className="absolute top-10 right-10 bg-black text-white p-10 flex flex-col gap-4">
      ...
      <motion.section
        ...
        viewport={{ once: false, amount: 0.2 }}
        variants={containerVariants}
        className="py-40 px-6 md:px-20 bg-[#080808]"
      >
      ...
      <motion.section
        ...
        variants={containerVariants}
        className="h-[90vh] flex flex-col items-center justify-center bg-black relative overflow-hidden"
      >
        <motion.div
          variants={itemVariants}
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            <Link to="/tickets">
              <motion.button
                ...
                className="bg-amber-600 text-black px-16 py-8 text-[11px] tracking-[0.6em] font-black uppercase rounded-sm shadow-[0_0_50px_rgba(245,158,11,0.2)]"
              >
                Comprar Entrada
              </motion.button>
            </Link>

            <button className="text-[10px] tracking-[0.5em] uppercase font-bold text-zinc-500 border-b border-zinc-900 pb-2 hover:text-white transition-colors">
